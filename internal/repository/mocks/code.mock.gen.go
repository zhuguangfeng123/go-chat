...
func (m *MockCodeRepository) DeleteCode(ctx context.Context, biz, phone string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteCode", ctx, biz, phone)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteCode indicates an expected call of DeleteCode.
func (mr *MockCodeRepositoryMockRecorder) DeleteCode(ctx, biz, phone any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteCode", reflect.TypeOf((*MockCodeRepository)(nil).DeleteCode), ctx, biz, phone)
}
